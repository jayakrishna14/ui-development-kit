...
const sdkPreload = {
    ...
    createAccessModelMetadataAttribute: (request) => ipcRenderer.invoke('create-access-model-metadata-attribute', request),
    createAccessModelMetadataAttributeValue: (request) => ipcRenderer.invoke('create-access-model-metadata-attribute-value', request),
    ...
    updateAccessModelMetadataAttribute: (request) => ipcRenderer.invoke('update-access-model-metadata-attribute', request),
    updateAccessModelMetadataAttributeValue: (request) => ipcRenderer.invoke('update-access-model-metadata-attribute-value', request),
    updateAccessModelMetadataByFilter: (request) => ipcRenderer.invoke('update-access-model-metadata-by-filter', request),
    updateAccessModelMetadataByIds: (request) => ipcRenderer.invoke('update-access-model-metadata-by-ids', request),
    updateAccessModelMetadataByQuery: (request) => ipcRenderer.invoke('update-access-model-metadata-by-query', request),
    ...
    getTotalCount: (request) => ipcRenderer.invoke('get-total-count', request),
    listApiSummary: (request) => ipcRenderer.invoke('list-api-summary', request),
    ...
    startApplicationDiscovery: (request) => ipcRenderer.invoke('start-application-discovery', request),
    approveApproval: (request) => ipcRenderer.invoke('approve-approval', request),
    approveApprovalInBulk: (request) => ipcRenderer.invoke('approve-approval-in-bulk', request),
    cancelApproval: (request) => ipcRenderer.invoke('cancel-approval', request),
    deleteApprovalConfigRequest: (request) => ipcRenderer.invoke('delete-approval-config-request', request),
    getApproval: (request) => ipcRenderer.invoke('get-approval', request),
    getApprovals: (request) => ipcRenderer.invoke('get-approvals', request),
    getApprovalsConfig: (request) => ipcRenderer.invoke('get-approvals-config', request),
    moveApproval: (request) => ipcRenderer.invoke('move-approval', request),
    putApprovalsConfig: (request) => ipcRenderer.invoke('put-approvals-config', request),
    rejectApproval: (request) => ipcRenderer.invoke('reject-approval', request),
    rejectApprovalInBulk: (request) => ipcRenderer.invoke('reject-approval-in-bulk', request),
    updateApprovalsAttributes: (request) => ipcRenderer.invoke('update-approvals-attributes', request),
    updateApprovalsComments: (request) => ipcRenderer.invoke('update-approvals-comments', request),
    updateApprovalsReassign: (request) => ipcRenderer.invoke('update-approvals-reassign', request),
    ...
    searchFormInstancesByTenant: (request) => ipcRenderer.invoke('search-form-instances-by-tenant', request),
    ...
    createCustomUserLevel: (request) => ipcRenderer.invoke('create-custom-user-level', request),
    deleteUserLevel: (request) => ipcRenderer.invoke('delete-user-level', request),
    getUserLevel: (request) => ipcRenderer.invoke('get-user-level', request),
    listAllAuthorizationRightSets: (request) => ipcRenderer.invoke('list-all-authorization-right-sets', request),
    listUserLevelIdentities: (request) => ipcRenderer.invoke('list-user-level-identities', request),
    listUserLevels: (request) => ipcRenderer.invoke('list-user-levels', request),
    publishCustomUserLevel: (request) => ipcRenderer.invoke('publish-custom-user-level', request),
    showUserLevelCounts: (request) => ipcRenderer.invoke('show-user-level-counts', request),
    updateUserLevel: (request) => ipcRenderer.invoke('update-user-level', request),
    cancelTask: (request) => ipcRenderer.invoke('cancel-task', request),
    createApplication: (request) => ipcRenderer.invoke('create-application', request),
    createSchedule: (request) => ipcRenderer.invoke('create-schedule', request),
    dasOwnersAssignPost: (request) => ipcRenderer.invoke('das-owners-assign-post', request),
    dasOwnersOwnerIdentityIdResourcesGet: (request) => ipcRenderer.invoke('das-owners-owner-identity-id-resources-get', request),
    dasOwnersReelectPost: (request) => ipcRenderer.invoke('das-owners-reelect-post', request),
    dasOwnersResourcesResourceIdGet: (request) => ipcRenderer.invoke('das-owners-resources-resource-id-get', request),
    dasOwnersSourceIdentityIdReassignDestinationIdentityIdPost: (request) => ipcRenderer.invoke('das-owners-source-identity-id-reassign-destination-identity-id-post', request),
    deleteApplication: (request) => ipcRenderer.invoke('delete-application', request),
    deleteSchedule: (request) => ipcRenderer.invoke('delete-schedule', request),
    deleteTask: (request) => ipcRenderer.invoke('delete-task', request),
    getApplication: (request) => ipcRenderer.invoke('get-application', request),
    getApplications: (request) => ipcRenderer.invoke('get-applications', request),
    getOwners: (request) => ipcRenderer.invoke('get-owners', request),
    getSchedule: (request) => ipcRenderer.invoke('get-schedule', request),
    getSchedules: (request) => ipcRenderer.invoke('get-schedules', request),
    getTask: (request) => ipcRenderer.invoke('get-task', request),
    getTasks: (request) => ipcRenderer.invoke('get-tasks', request),
    putApplication: (request) => ipcRenderer.invoke('put-application', request),
    putSchedule: (request) => ipcRenderer.invoke('put-schedule', request),
    startTaskRerun: (request) => ipcRenderer.invoke('start-task-rerun', request),
    ...
    sendDeclassifyMachineAccountFromSource: (request) => ipcRenderer.invoke('send-declassify-machine-account-from-source', request),
    ...
    patchPotentialRoleSession: (request) => ipcRenderer.invoke('patch-potential-role-session', request),
    ...
    listEntitlementsByIdentity: (request) => ipcRenderer.invoke('list-entitlements-by-identity', request),
    ...
    createLauncher: (request) => ipcRenderer.invoke('create-launcher', request),
    deleteLauncher: (request) => ipcRenderer.invoke('delete-launcher', request),
    getLauncher: (request) => ipcRenderer.invoke('get-launcher', request),
    getLaunchers: (request) => ipcRenderer.invoke('get-launchers', request),
    putLauncher: (request) => ipcRenderer.invoke('put-launcher', request),
    startLauncher: (request) => ipcRenderer.invoke('start-launcher', request),
    ...
    createMachineAccountSubtype: (request) => ipcRenderer.invoke('create-machine-account-subtype', request),
    deleteMachineAccountSubtype: (request) => ipcRenderer.invoke('delete-machine-account-subtype', request),
    getMachineAccount: (request) => ipcRenderer.invoke('get-machine-account', request),
    getMachineAccountSubtypeById: (request) => ipcRenderer.invoke('get-machine-account-subtype-by-id', request),
    getMachineAccountSubtypeByTechnicalName: (request) => ipcRenderer.invoke('get-machine-account-subtype-by-technical-name', request),
    listMachineAccountSubtypes: (request) => ipcRenderer.invoke('list-machine-account-subtypes', request),
    listMachineAccounts: (request) => ipcRenderer.invoke('list-machine-accounts', request),
    patchMachineAccountSubtype: (request) => ipcRenderer.invoke('patch-machine-account-subtype', request),
    ...
    listMachineIdentityUserEntitlements: (request) => ipcRenderer.invoke('list-machine-identity-user-entitlements', request),
    startMachineIdentityAggregation: (request) => ipcRenderer.invoke('start-machine-identity-aggregation', request),
    ...
    getManagedClientHealthIndicators: (request) => ipcRenderer.invoke('get-managed-client-health-indicators', request),
    ...
    deleteMultiHostSources: (request) => ipcRenderer.invoke('delete-multi-host-sources', request),
    ...
    createParameter: (request) => ipcRenderer.invoke('create-parameter', request),
    deleteParameter: (request) => ipcRenderer.invoke('delete-parameter', request),
    getAttestationDocument: (request) => ipcRenderer.invoke('get-attestation-document', request),
    getParameter: (request) => ipcRenderer.invoke('get-parameter', request),
    getParameterReferences: (request) => ipcRenderer.invoke('get-parameter-references', request),
    getParameterStorageSpecification: (request) => ipcRenderer.invoke('get-parameter-storage-specification', request),
    searchParameters: (request) => ipcRenderer.invoke('search-parameters', request),
    updateParameter: (request) => ipcRenderer.invoke('update-parameter', request),
    ...
    createCustomPrivilegeCriteria: (request) => ipcRenderer.invoke('create-custom-privilege-criteria', request),
    deleteCustomPrivilegeCriteria: (request) => ipcRenderer.invoke('delete-custom-privilege-criteria', request),
    getPrivilegeCriteria: (request) => ipcRenderer.invoke('get-privilege-criteria', request),
    listPrivilegeCriteria: (request) => ipcRenderer.invoke('list-privilege-criteria', request),
    putCustomPrivilegeCriteriaValue: (request) => ipcRenderer.invoke('put-custom-privilege-criteria-value', request),
    getPrivilegeCriteriaConfig: (request) => ipcRenderer.invoke('get-privilege-criteria-config', request),
    listPrivilegeCriteriaConfig: (request) => ipcRenderer.invoke('list-privilege-criteria-config', request),
    patchPrivilegeCriteriaConfig: (request) => ipcRenderer.invoke('patch-privilege-criteria-config', request),
    ...
    cancelRolePropagation: (request) => ipcRenderer.invoke('cancel-role-propagation', request),
    getOngoingRolePropagation: (request) => ipcRenderer.invoke('get-ongoing-role-propagation', request),
    getRolePropagationStatus: (request) => ipcRenderer.invoke('get-role-propagation-status', request),
    startRolePropagation: (request) => ipcRenderer.invoke('start-role-propagation', request),
    ...
    createStream: (request) => ipcRenderer.invoke('create-stream', request),
    deleteStream: (request) => ipcRenderer.invoke('delete-stream', request),
    getJWKSData: () => ipcRenderer.invoke('get-jwks-data'),
    getSSFConfiguration: () => ipcRenderer.invoke('get-ssf-configuration'),
    getStream: (request) => ipcRenderer.invoke('get-stream', request),
    getStreamStatus: (request) => ipcRenderer.invoke('get-stream-status', request),
    sendStreamVerification: (request) => ipcRenderer.invoke('send-stream-verification', request),
    setStreamConfiguration: (request) => ipcRenderer.invoke('set-stream-configuration', request),
    updateStreamConfiguration: (request) => ipcRenderer.invoke('update-stream-configuration', request),
    updateStreamStatus: (request) => ipcRenderer.invoke('update-stream-status', request),
    ...
    listPasswordPolicyHoldersOnSource: (request) => ipcRenderer.invoke('list-password-policy-holders-on-source', request),
    ...
    createTag: (request) => ipcRenderer.invoke('create-tag', request),
    deleteTagById: (request) => ipcRenderer.invoke('delete-tag-by-id', request),
    getTagById: (request) => ipcRenderer.invoke('get-tag-by-id', request),
    listTags: (request) => ipcRenderer.invoke('list-tags', request),
    ...
    getWorkflowExecutionHistoryV2: (request) => ipcRenderer.invoke('get-workflow-execution-history-v2', request),
    ...
    listWorkflows: (request) => ipcRenderer.invoke('list-workflows', request),
    ...
    searchAdvancedSearchbyIDNerm: (request) => ipcRenderer.invoke('search-advanced-searchby-id-nerm', request),
